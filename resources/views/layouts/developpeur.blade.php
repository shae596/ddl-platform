...
<head>
    ...
    <title>@yield('title', config('ddl.acronym')) — Développeur</title>
        ...
        <div class="app-header__inner">
            ...
            <div class="app-user">
                @if(isset($notificationsNonLues) && $notificationsNonLues > 0)
                    <a href="{{ route('developpeur.dashboard') }}#notifications" class="notif-badge-link" title="Notifications non lues">
    ...
    <div class="app-shell">
        <aside class="app-sidebar">
            <nav class="sidebar-nav">
                <a href="{{ route('developpeur.dashboard') }}" class="{{ request()->routeIs('developpeur.dashboard') ? 'active' : '' }}">Tableau de bord</a>
                <a href="{{ route('developpeur.demandes.index') }}" class="{{ request()->routeIs('developpeur.demandes.*') ? 'active' : '' }}">Mes affectations</a>
            </nav>
        </aside>
